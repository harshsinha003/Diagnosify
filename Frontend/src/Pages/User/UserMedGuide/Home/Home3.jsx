...
//------------------------------------------------------------------------------------------------------
//New code of the opacity because of the black overlays
...
const Home3 = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Content */}
      <div style={{ position: 'relative', zIndex: 2 }} className="px-24 py-3 mb-32">
        <h1 className="text-7xl text-center py-7 font-bold mb-4 text-white">FAQs</h1>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isActive ? '1px solid #00d4aa' : '1px solid rgba(255, 255, 255, 0.1)',
                  backdropFilter: 'blur(10px)',
                  marginBottom: '1rem'
                }}
                className={`hs-accordion rounded-2xl transition-all duration-300`}
              >
                <button
                  className={`hs-accordion-toggle transition ${
                    isActive ? "text-white" : "text-gray-200"
                  } inline-flex justify-between items-center gap-x-3 w-full text-xl font-semibold text-start py-4 px-5 hover:text-white`}
                  onClick={() => handleAccordionToggle(index)}
                  aria-expanded={isActive}
                  aria-controls={`hs-basic-active-bordered-collapse-${index + 1}`}
                >
                  ...
                  <FontAwesomeIcon 
                    ...
                    style={{ color: isActive ? '#00d4aa' : '#d0d0d0' }}
                  />
                </button>
                <div
                  id={`hs-basic-active-bordered-collapse-${index + 1}`}
